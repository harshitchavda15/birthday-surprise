...
const timelineEvents = [
  ...
  },
  {
    emoji: "⛈️",
    title: "The Storm (Now)",
    description: "Yes, we're going through a rough patch. But guess what? Every rainbow needs a little rain first! 🌈",
  ...
  },
  {
    emoji: "🌈",
    title: "The Future (Us!)",
    description: "This is where it gets good! More laughs, more love, more adventures, and fewer arguments (I hope 😅)! 💝",
